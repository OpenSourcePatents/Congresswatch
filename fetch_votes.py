...
try:
r = requests.get(url, headers={‘User-Agent’: ‘CongressWatch/1.0 (public-interest-research; mailto:project.congress.watch@gmail.com)’}, timeout=10)
...
print(f’    [!] HTTP {r.status_code} for bioguide {bid}’)
except Exception:
pass
return None
