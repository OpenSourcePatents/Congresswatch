...
“””
Congress.gov returns chambers inconsistently.
Force correct value based on raw string + district presence.
“””
...
return ‘House’
# Fallback: senators have no numeric district
...
“”“Fetch all members for a given chamber with pagination.”””
params = {
...
# Use forced_chamber from which API call we made (most reliable)
chamber = forced_chamber

# Get term start from terms array if available
term_start = ''
terms = m.get('terms', {})
...
# Deduplicate by bioguide ID

# Use forced chamber from which fetch we called — most reliable
